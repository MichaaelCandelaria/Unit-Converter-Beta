...
while True:
    ...
    # Metric Mass
            ...
            print('     1. grams to kilograms 2. grams to tonnes 3. kilograms to grams \n 4. kilograms to tonnes 5. tonnes to grams 6. tonnes to kilograms')
            conversion = int(input('Please enter the METRIC LENGTH you wish to convert: '))
        # Grams to Kilograms
            if conversion == 1:
                x = float(input('Please enter the value you wish to convert: '))
                print(float(x) / int(1000), 'Kilograms')
        # Grams to Tonnes
            elif conversion == 2:
                x = float(input('Please enter the value you wish to convert: '))
                print(float(x) / 1000000, 'Tonnes')
        # Kilograms to Grams
            elif conversion == 3:
                x = float(input('Please enter the value you wish to convert: '))
                print(float(x) * 1000, 'Grams')
        # Kilograms to Tonnes
            elif conversion == 4:
                x = float(input('Please enter the value you wish to convert: '))
                print(float(x) / 1000, 'Tonnes')
        # Tonnes to Grams
            elif conversion == 5:
                x = float(input('Please enter the value you wish to convert: '))
                print(float(x) * 1000000, 'Grams')
        # Tonnes to Kilograms
            elif conversion == 6:
                x = float(input('Please enter the value you wish to convert: '))
                print(float(x) * 1000, 'Kilograms')
            break
